  ...
  return (
    <>
      ...
      <div className={isMobile ? 'info-main-mobile' : 'info-main'}>
        ...
        <br></br>
        <p>
          You agree to indemnify, defend and hold harmless Nolita Dirtbag and
  ...
  return (
    <>
      ...
      <div className={isMobile ? 'info-main-mobile' : 'info-main'}>
        ...
        <br></br>
        <p>
          Packages ship within 7 business days from the date we receive the
          order. They will arrive 7-10 days later. Items are shipped directly
          from New York, USA using the US Postal Service.
        </p>
        <br></br>
        <br></br>
        <p>RETURNS</p>
        ...
        <p>
          ...
          same condition that you received it, with all tags and packaging
          intact.
        </p>
        <br></br>
        <p>
          To initiate a return, please contact us at team@nolitadirtbag.com with
          your order number and a description of the problem. We will provide
          you with instructions on how to return the item to us.
        </p>
        <br></br>
        <p>
          You will be responsible for shipping the item back to us, unless we
          made an error in sending you the wrong size or product.
        </p>
        <br></br>
        <p>
    ...
    <>
      ...
      <div className={isMobile ? 'info-main-mobile' : 'info-main'}>
        ...
        <p>
          ...
          business purpose: shared with our processor Shopify. Personal
          Information collected: name, billing address, shipping address,
        ...
        <p>
          ...
          request deletion. Sharing Personal Information
        </p>
        <br></br>
        <p>
          ...
          above. We use Shopify to power our online store. You can read more
        ...
        <p>
          ...
          products, services, and offers. Lawful basis Pursuant to the General
          Data Protection Regulation (“GDPR”), if you are a resident of the
          European Economic Area (“EEA”), we process your personal information
          under the following lawful bases: Your consent; The performance of the
          contract between you and the Site; Compliance with our legal
          obligations; To protect your vital interests; To perform a task
        ...
        <p>
          ...
          through your browser controls, often found in your browser’s “Tools”
          or “Preferences” menu. For more information on how to modify your
          browser settings or how to block, manage or filter cookies can be
          found in your browser’s help file or through such sites as:
          www.allaboutcookies.org. Additionally, please note that blocking
        ...
        <p>
          ...
          above. If you are not satisfied with our response to your complaint,
          you have the right to lodge your complaint with the relevant data
          protection authority. You can contact your local data protection
          authority, or our supervisory authority here: team@nolitadirtbag.com
        </p>
        <br></br>
